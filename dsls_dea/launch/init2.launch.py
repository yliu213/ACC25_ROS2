...
def generate_launch_description():
    ...
    # Delayed service call for attach
    attach_uav0 = ExecuteProcess(
        cmd=[
            'ros2', 'service', 'call',
            '/gazebo_ros2_link_attacher/attach',
            'gazebo_ros2_link_attacher/srv/Attach',
            "{model_name_1: 'px4vision_0', link_name_1: 'base_link', model_name_2: 'slung_load', link_name_2: 'ball_hinge_0::base_link'}"
        ],
        output='screen',
    )

    attach_uav1 = ExecuteProcess(
        cmd=[
            'ros2', 'service', 'call',
            '/gazebo_ros2_link_attacher/attach',
            'gazebo_ros2_link_attacher/srv/Attach',
            "{model_name_1: 'px4vision_1', link_name_1: 'base_link', model_name_2: 'slung_load', link_name_2: 'ball_hinge_1::base_link'}"
        ],
        output='screen',
    )

    # Delay attach by 7 seconds
