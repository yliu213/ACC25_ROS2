...
void DSL_api(const mxArray *const prhs[5], int32_T nlhs, const mxArray *plhs[3])
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
  ...
  xidot = (real_T(*)[4])mxMalloc(sizeof(real_T[4]));
  ...
  DSL(*z, *k, *param, *ref, t, *F1, *F2, *xidot);
  ...
  if (nlhs > 2) {
    plhs[2] = b_emlrt_marshallOut(*xidot);
  }
}
...
// End of code generation (_coder_DSL_api.cpp)
